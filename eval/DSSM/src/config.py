#coding:utf-8
TEST_DATASET_PATH = 'data_bpe/test1w.query'
...
class cnn2seq_config(object):
  def __init__(self):
    ...
    self.model_dir = 'states_cnn_models'
    self.vocab_size = 60000
    self.max_train_data_size = 200000
    self.results_dir = 'results/states_cnn_1w.txt'
...
class seq2seq_config(object):
  def __init__(self):
    self.data_dir = 'data_bpe'
    self.model_dir = 'seq2seq_4layers'
    self.vocab_size = 60000
    self.max_train_data_size = 0
    self.results_dir = 'results/seq2seq_4layers_1w.txt'
...
class ASM_config(object):
  def __init__(self):
    self.data_dir = '/home/zyma/work/projects/cnn2seq/data_bpe'
