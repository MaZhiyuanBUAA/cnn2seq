#coding:utf-8
TEST_DATASET_PATH = 'data_bpe/test1k.query'
...
class cnn2seq_config(object):
  def __init__(self):
    ...
    self.model_dir = 'inputs_cnn_models'
    self.vocab_size = 60000
    self.max_train_data_size = 200000
    self.results_dir = 'results/inputs_cnn.txt'
...
class seq2seq_config(object):
  def __init__(self):
    ...
    self.results_dir = 'results/seq2seq_4layers.txt'
